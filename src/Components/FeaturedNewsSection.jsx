...
const newsArticles = [
  {
    ...
    desc: "বাংলাদেশে পর্যটকদের জন্য জনপ্রিয় যানবহন 'চান্দের গাড়ি' এবার যুক্ত হলো অনলাইন অ্যাপ ভিত্তিক প্ল্যাটফর্মে। গাড়িবুক দেশের প্রথম অ্যাপ হিসাবে পর্যটকদের জন্য এই বিশেষ যানটি বুকিং সুবিধা নিয়ে এলো।",
  ...
  },
  {
    ...
    desc: "দেশের শীর্ষস্থানীয় অ্যাপভিত্তিক প্ল্যাটফর্ম গাড়িবুক স্মার্ট চালক ও তাদের পরিবারের উন্নত স্বাস্থ্যসেবা নিশ্চিত করতে ডিজিটাল স্বাস্থ্যসেবা প্ল্যাটফর্ম 'সুধী'-এর সঙ্গে একটি গুরুত্বপূর্ণ চুক্তি স্বাক্ষর করেছে।",
    publisher: 'কালের কণ্ঠ',
    image: meetingImg1,
  },
  {
    id: 3,
    date: 'January 29, 2025',
    title: 'গাড়িচালক ও তাদের পরিবারের স্বাস্থ্যসেবায় গাড়িবুক-সুধীর চুক্তি স্বাক্ষর',
    desc: "গাড়িবুক দেশের শীর্ষস্থানীয় অ্যাপভিত্তিক প্ল্যাটফর্ম। সম্প্রতি তারা গ্রামীণ ডিজিটাল হেলথকেয়ার সলিউশনসের ডিজিটাল স্বাস্থ্যসেবা প্ল্যাটফর্ম 'সুধী'-এর সঙ্গে একটি গুরুত্বপূর্ণ চুক্তি স্বাক্ষর করেছে। যেখানে তারা স্মার্ট চালক ও তাদের পরিবারের জন্য উন্নত...",
    publisher: 'ইত্তেফাক',
    image: meetingImg2,
  },
  {
    ...
    title: 'নিরাপদ ও নির্ভরযোগ্য যাতায়াতে গাড়িবুক নিয়ে এলো প্রিমিয়াম সেবাসমূহ',
    desc: 'যাত্রীদের সর্বোচ্চ আরাম ও নির্ভরযোগ্য ভ্রমণ নিশ্চিতে বিশেষ ট্রাভেল প্যাকেজ এবং প্রিমিয়াম গাড়ির বহর চালু করেছে দেশের শীর্ষস্থানীয় ডিজিটাল রাইড প্ল্যাটফর্ম গাড়িবুক।',
    publisher: 'প্রথম আলো',
    image: chanderGariImg,
  },
]
